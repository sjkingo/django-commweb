...
from commweb.payment import TransactionPayment
...
class TestResponses(unittest.TestCase):
    ...
    def construct_transaction(self, amount, order_info):
        p = TransactionPayment(amount=amount, order_info=order_info,
    ...
    def test_approved(self):
        t = self.construct_transaction(Decimal('1.00'), 'test_approved')
        r = t.process()
    ...
    def test_failed(self):
        t = self.construct_transaction(Decimal('1.10'), 'test_failed')
        try:
            r = t.process()
    ...
    def test_declined_E(self):
        t = self.construct_transaction(Decimal('1.01'), 'test_declined_E')
        try:
            r = t.process()
        except PaymentDeclinedError, e:
    ...
    def test_declined_2(self):
        t = self.construct_transaction(Decimal('1.05'), 'test_declined_2')
        try:
            r = t.process()
        except PaymentDeclinedError, e:
    ...
    def test_no_reply(self):
        t = self.construct_transaction(Decimal('1.68'), 'test_no_reply')
        try:
            r = t.process()
        except PaymentDeclinedError, e:
    ...
    def test_card_expired(self):
        t = self.construct_transaction(Decimal('1.54'), 'test_card_expired')
        try:
            r = t.process()
        except PaymentDeclinedError, e:
    ...
    def test_insufficient_credit(self):
        t = self.construct_transaction(Decimal('1.51'), 'test_insufficient_credit')
        try:
            r = t.process()
        except PaymentDeclinedError, e:
